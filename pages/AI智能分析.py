...
- 变卦所预示的未来趋势
- 变化过程中需要注意的关键点
要求分析透彻，字数控制在120-180字，必须直接开始内容，不要添加任何引导语。
...
- 动爻所在位置的特殊意义
- 动爻变化带来的机遇与挑战
要求解读精准，字数控制在120-180字，必须直接开始内容，不要添加任何引导语。
...
- 世应关系的深层含义
- 纳甲五行的生克制化
要求分析全面，字数控制在150-200字，必须直接开始内容，不要添加任何引导语。
...
要求分析全面深入，建议具体可行，内容详实丰富，字数控制在1000-1500字"""
    else:
        prompt += f"""
...
要求分析全面，建议实用，内容详实丰富，字数控制在1000-1500字"""
